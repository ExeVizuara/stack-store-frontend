...
import { createWeeklySale } from "../graphql/mutations";
const client = generateClient();
export default function WeeklySaleCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createWeeklySale.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "WeeklySaleCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
