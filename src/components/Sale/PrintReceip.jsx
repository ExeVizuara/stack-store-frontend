...
export function PrintReceipt({ products, total, quit }) {
    ...
    return (
        <div className="absolute left-0 top-0 w-full h-full bg-[#0f100f7b] z-10 p-32">
            <div className="flex flex-col items-center justify-center bg-white px-20 py-10 rounded-md w-auto relative">
            <button className="absolute right-6 top-1 bg-red-500 border border-red-800 px-1" onClick={quit}>x</button>
                ...
                <h1 className="text-2xl text-slate-600 mb-4 border border-b-8 px-2">TICKET COMPROBANTE</h1>
